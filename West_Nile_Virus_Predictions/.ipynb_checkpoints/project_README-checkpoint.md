...
In this section, we have included several resources that might aid you in this project. 
1. Collaborating as a team using Github ([link](https://www.freecodecamp.org/news/how-to-use-git-and-github-in-a-team-like-a-pro/))
2. Methods to address imbalanced classes in a classification problem ([link](https://www.analyticsvidhya.com/blog/2020/07/10-techniques-to-deal-with-class-imbalance-in-machine-learning/))
